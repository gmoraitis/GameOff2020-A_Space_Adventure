  ...
  document.addEventListener("keypress", function (event) {
    ...
    if (event.key === "Enter") {
      ...
      // East
        ...
        var textnode = document.createTextNode("Also nothing here but hey look carefully there is a bottle with some special magic juice. Some of the wizard's old tricks...Drink it to get power to continue, and try something else...");
        node.appendChild(textnode);
        document.getElementById("computer").appendChild(node);
      }
